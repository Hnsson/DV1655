...
%type <Node *> root goal mainClass classDeclaration classDeclaration_inf varDeclaration varDeclaration_inf methodDeclaration methodDeclaration_inf methodContent methodContentParam methodHeader methodParam expression expression_inf factor statement statement_inf identifier type
...
methodContentParam: varDeclaration {$$ = $1;}
                  | statement {$$ = $1;}
                  | varDeclaration methodContentParam
                    {
                      $$ = new Node("MethodContents", "", yylineno);
                      $$->children.push_back($1);
                      $$->children.push_back($2);
                    }
                  | statement methodContentParam
                    {
                      $$ = new Node("MethodContents", "", yylineno);
                      $$->children.push_back($1);
                      $$->children.push_back($2);
